...
namespace WinterStrap.AspNet.SourceGenerators.Helpers;
    ...
    where T : IEquatable<T>
{
    ...
    /// <sinheritdoc/>
    public bool Equals(EquatableArray<T> equatableArray)
    {
        return AsSpan().SequenceEqual(equatableArray.AsSpan());
    }

    /// <sinheritdoc/>
    public override bool Equals([NotNullWhen(true)] object? obj)
    {
        return obj is EquatableArray<T> equatableArray && Equals(this, equatableArray);
    }
