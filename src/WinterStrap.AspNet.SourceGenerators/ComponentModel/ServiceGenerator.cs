...
public class ServiceGenerator : ISourceGenerator
{
     ...
     public void Execute(GeneratorExecutionContext context)
    {
        ...
        //To have access to RootNamespace property in csproj file we need to add this line to csproj file   
        //<ItemGroup>
        ...
        sourceBuilder.AppendLine("    }");
        sourceBuilder.AppendLine("}");
        context.AddSource("ServiceDependencyInjection.generated.cs",
